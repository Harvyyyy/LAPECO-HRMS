...
const TrainingPage = ({ trainingPrograms, enrollments, handlers }) => {
  ...
  const handleSaveProgram = (formData, programId) => { handlers.saveProgram(formData, programId); handleCloseProgramModal(); };
