...
const PerformanceManagementPage = ({ kras, kpis, positions, employees, evaluations, handlers }) => {
  ...
  const handleSaveKraAndKpis = (kraData, kpiList) => {
    handlers.saveKraAndKpis(kraData, kpiList);
    handleCloseKraModal();
  };
  ...
  return (
    <div className="container-fluid p-0 page-module-container">
      ...
      <StartEvaluationModal show={showStartEvalModal} onClose={() => setShowStartEvalModal(false)} onStart={(data) => navigate('/dashboard/performance/evaluate', { state: data })} employees={employees}/>
