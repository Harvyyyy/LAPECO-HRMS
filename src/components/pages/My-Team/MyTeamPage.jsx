...
const MyTeamPage = ({ currentUser, employees, positions, handlers }) => {
  ...
  const handleOpenReportPage = (employee) => {
    navigate('/dashboard/submit-report', {
      state: { employeeToReportId: employee.id }
    });
  };
                  ...
                  <div className="card-actions">
                    <div className="dropdown">
                      ...
                      <ul className="dropdown-menu dropdown-menu-end">
                        ...
                        <li><a className="dropdown-item" href="#" onClick={(e) => { e.preventDefault(); handleOpenReportPage(member); }}>Report Incident</a></li>
                      </ul>
                    </div>
                  </div>
                )
