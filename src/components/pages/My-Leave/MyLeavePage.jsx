    ...
    <div className="container-fluid p-0 page-module-container">
      ...
      <div className="my-leave-dashboard">
        <div className="leave-balances">
            ...
            <div className="balance-card"><div className="balance-icon icon-personal"><i className="bi bi-person-badge"></i></div><div className="balance-info"><span className="balance-value">{leaveBalances.personal}</span><span className="balance-label">Personal Days Left</span></div></div>
        </div>
