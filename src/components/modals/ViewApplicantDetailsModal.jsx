            ...
            <div className="applicant-details-container">
              <div className="profile-sidebar">
                ...
                <div className="profile-key-info">
                    ...
                    <div className="info-item"><i className="bi bi-calendar-plus-fill"></i><span>Applied: {formatDate(applicant.applicationDate)}</span></div>
                    <div className="info-item"><i className="bi bi-calendar-check-fill"></i><span>Interview: {formatDate(applicant.interviewDate)}</span></div>
                </div>
                  ...
                  {activeTab === 'personal' && (
                    <div>
                      ...
                      <div className="row g-4">
                        <div className="col-md-4 detail-group"><p className="detail-label">First Name</p><p className="detail-value">{applicant.firstName || 'N/A'}</p></div>
                        <div className="col-md-4 detail-group"><p className="detail-label">Middle Name</p><p className="detail-value">{applicant.middleName || 'N/A'}</p></div>
                        <div className="col-md-4 detail-group"><p className="detail-label">Last Name</p><p className="detail-value">{applicant.lastName || 'N/A'}</p></div>
