...
const AddEditEmployeeModal = ({ show, onClose, onSave, employeeData, positions }) => {
  const initialFormState = {
    ...
    imageUrl: null, imagePreviewUrl: employeeData?.imageUrl || placeholderImage,
  ...
  const handleSubmit = (e) => {
    ...
    if (validateForm()) {
      ...
      if (formErrors.email || formErrors.contactNumber || formErrors.birthday || formErrors.gender || formErrors.address) {
              ...
              <div className="employee-form-container">
                <div className="employee-form-left-column">
                  ...
                  <div className="form-group">
                    ...
                    <select className={`form-select ${formErrors.positionId ? 'is-invalid' : ''}`} id="positionId" name="positionId" value={formData.positionId} onChange={handleChange} required>
                  ...
                  <div className="form-group">
                    ...
                    <input type="date" className={`form-control ${formErrors.joiningDate ? 'is-invalid' : ''}`} id="joiningDate" name="joiningDate" value={formData.joiningDate} onChange={handleChange} required />
